...
import nerfacc_v053.csrc.nerfacc as nerfacc_cuda
...
def ray_aabb_intersect(
    ...
    t_mins, t_maxs, hits = nerfacc_cuda.ray_aabb_intersect(
        rays_o.contiguous(),
        rays_d.contiguous(),
        aabbs.contiguous(),
        near_plane,
...
def traverse_grids(
    ...
    # Traverse the grids.
    intervals, samples, termination_planes = nerfacc_cuda.traverse_grids(
        # rays
