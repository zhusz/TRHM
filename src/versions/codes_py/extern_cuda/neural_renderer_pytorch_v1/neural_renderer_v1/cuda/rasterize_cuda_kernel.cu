...
at::Tensor forward_face_info_onto_map_cuda(at::Tensor face_index_map,
    ...
    AT_DISPATCH_FLOATING_TYPES(face_info.scalar_type(), "forward_face_info_onto_map_cuda", ([&] {
...
at::Tensor forward_vert_info_onto_map_cuda(at::Tensor face_index_map,
    ...
    AT_DISPATCH_FLOATING_TYPES(vert_info.scalar_type(), "forward_vert_info_onto_map_cuda", ([&] {
...
at::Tensor forward_grid_sampling_cuda(
    ...
    AT_DISPATCH_FLOATING_TYPES(infoA.scalar_type(), "forward_grid_sampling_cuda", ([&] {
...
at::Tensor forward_get_edge_mask_cuda(
    ...
    AT_DISPATCH_FLOATING_TYPES(faces_xy.scalar_type(), "forward_get_edge_mask_cuda", ([&] {
