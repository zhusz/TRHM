...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("march_rays_train_raysInfo", &march_rays_train_raysInfo, "march_rays_train_raysInfo (CUDA)");
    ...
    // m.def("composite_rays_train_refnerf_forward", &composite_rays_train_refnerf_forward, "composite_rays_train_refnerf_forward (CUDA)");
    // m.def("composite_rays_train_refnerf_backward", &composite_rays_train_refnerf_backward, "composite_rays_train_refnerf_backward (CUDA)");
    // infer
